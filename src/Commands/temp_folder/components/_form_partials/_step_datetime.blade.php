<div class="stepDescription d-none" id="stepDescription">
    <div class="mb-5 d-flex align-items-center">
        <button type="button" class="btn btn-info prev circle me-3" id="prev-btn-description"
            style="height: 40px; width:40px">
            <i class="fa-solid fa-arrow-left"></i>
        </button>

         <h4 style="font-weight: 800" class="pl-2">Preferred Date & Time</h4>
    </div>
    <div class="row">
        ...
        @include($viewPath . '::components.forms._step_calendar')

                ...
                <v-col cols="12">
                    ...
                    <div>
                        ...
                        <div class="text-center pt-4">
                             <p style="cursor: pointer;" @click="$router.push({ name: 'vendorClientLoginPage' })"><v-icon>mdi-arrow-left</v-icon> Back to Login</p>
                        </div>
                    </div>
    ...
    methods: {
        async handleSendEmail() {
            ...
            try {
                ...
                this.$router.push({ name: 'vendorClientLoginPage' });
            } catch (err) {
                this.error =

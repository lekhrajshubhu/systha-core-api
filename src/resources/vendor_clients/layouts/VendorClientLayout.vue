<template>
    <v-app>
        ...
        <!-- Global Modal -->
        <v-dialog v-model="globalModal.isOpen" :max-width="globalModal.width"
            :persistent="globalModal.persistent"
            :scrollable="globalModal.scrollable"
            :transition="globalModal.disableTransition ? false : undefined" content-class="global-modal-content">
...
import { useVendorClientStore } from '@/vendor_clients/stores/account'; // path might differ
...
export default {
            ...
            menuGroups: [
                {
                    groupTitle: '',
                    items: [
                        { title: 'Dashboard', icon: 'mdi-view-dashboard-outline', name: 'vendorClientDashboardPage' },
                        { title: 'Appointments', icon: 'mdi-calendar-check-outline', name: 'vendorClientAppointmentPage' },
                        { title: 'Estimates', icon: 'mdi-comment-question-outline', name: 'vendorClientInquiryPage' },
                        { title: 'Subscriptions', icon: 'mdi-certificate-outline', name: 'vendorClientSubscriptionPage' },
                    ],
                },
                {
                    groupTitle: 'Communications',
                    items: [
                        { title: 'Message', icon: 'mdi-chat-outline', name: 'vendorClientMessagePage' },
                        { title: 'Email Notifications', icon: 'mdi-email-outline', name: 'vendorClientEmailNotificationPage' },
                        // { title: 'Reviews', icon: 'mdi-star-outline', name: 'vendorClientReviewPage' },
                    ],
                },
                // {
                //     groupTitle: 'Invoices',
                //     items: [
                //         { title: 'Invoice', icon: 'mdi-file-document-outline', name: 'vendorClientInvoicePage' },
                //         { title: 'Payment', icon: 'mdi-credit-card-outline', name: 'vendorClientPaymentPage' },
                //     ],
                // },
                // {
                //     groupTitle: 'Notifications',
                //     items: [
                //         { title: 'Notification', icon: 'mdi-bell-outline', name: 'vendorClientNotificationPage' },
                //     ],
                // },
                {
                    groupTitle: 'Settings',
                    items: [
                        { title: 'Profile', icon: 'mdi-account-outline', name: 'vendorClientProfilePage' },
                        { title: 'Cards', icon: 'mdi-cog-outline', name: 'vendorClientCarsPage' },
                        { title: 'Logout', icon: 'mdi-logout-variant', name: '', action: 'logout' },
                    ],
                },
            ],
    ...
    computed: {
        ...mapState(useVendorClientStore, ['profileName', 'profileEmail', 'hasProfile']),
    ...
    methods: {
        ...mapActions(useVendorClientStore, ['fetchProfile']),
        updateDateTime() {
            const now = new Date();
            const options = {
                year: 'numeric',
        ...
        logout() {
            ...
            this.$router.replace({ name: "vendorClientLoginPage" });
        },
    },
    mounted() {

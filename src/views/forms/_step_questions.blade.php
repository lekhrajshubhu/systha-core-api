 ...
 <div id="stepContainer">
    <div class="mb-4 d-flex align-items-center">
        <button type="button" class="btn btn-primary me-3 d-none" id="btnBack" style="height: 40px; width:40px">
            <i class="fa-solid fa-arrow-left"></i>
        </button>
        <h4 id="stepTitle" class="fw-bold">Select a Service Category</h4>
    </div>
